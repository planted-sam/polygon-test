...
//
// This file has been copy-pasted from mapillary.js rather than imported through
// npm to avoid having to download the large bundle-size of mapillary.js every
// time our web app is opened.
//
// The purpose of this file is to convert between ENU and geodetic coordinates.
//
// Thank you mapillary.js!
//
// Source: https://github.com/mapillary/mapillary-js/blob/main/src/geo/GeoCoords.ts
...
export function enuToEcef(
  ...
  const X =
    -sinLng * x - sinLat * cosLng * y + cosLat * cosLng * z + refEcef[0];
